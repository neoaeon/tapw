...
describe "map_images/new.html.erb" do
  before(:each) do
    assign(:map_image, stub_model(MapImage,
      :mapType => "MyString",
      :uid => 1,
      :name => "MyString",
      :description => "MyText",
  ...
  it "renders new map_image form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => map_images_path, :method => "post" do
